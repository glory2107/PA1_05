...
<div class="page-wrapper-fasilitas">
    <div class="container-fluid titleArtikel py-4 text-center" style="margin-top: 0px; max-width: 1140px;">
        <div class="line-container">
            <hr class="solid-line">
            <h1 style="color: #003366; font-size: 2rem; font-weight: bold; display: inline-block;">FASILITAS</h1>
            <hr class="solid-line">
        </div>
    </div>
    ...
    <div class="container-fluid" style="max-width: 1140px;">
        <div class="boxJurusan">
            @forelse ($fasilitas as $item)
                <a href="{{ route('guest.fasilitassekolah.detail', $item->id) }}" class="text-decoration-none text-dark facility-item">
                    <div class="perBox">
