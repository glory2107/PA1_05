...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 my-8 animate-fade-in">
        <div>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">Isi informasi lengkap untuk event baru</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-md dark:bg-gray-800 overflow-hidden">
        ...
        <!-- Form Content -->
        <form action="{{ route('admin.event.store') }}" method="POST" enctype="multipart/form-data" class="p-6" id="eventForm">
            @csrf
