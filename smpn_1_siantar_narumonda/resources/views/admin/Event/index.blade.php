...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 my-8 animate-fade-in">
        <div>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">Kelola daftar berita sekolah</p>
        </div>
    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="overflow-hidden bg-white rounded-xl shadow-md dark:bg-gray-800 hover:shadow-xl transition-all duration-300 flex flex-col">
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-300">{{ \Carbon\Carbon::parse($event->tanggal)->format('d M Y') }}</p>
            </div>
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600 flex justify-end gap-4">
                <a href="{{ route('admin.event.edit', $event->id) }}"
                   class="inline-flex items-center px-3 py-1 text-sm font-medium text-blue-600 bg-blue-100 rounded hover:bg-blue-200 dark:bg-gray-600 dark:text-blue-300 dark:hover:bg-gray-500 transition mr-3">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                    </svg>
                    Edit
                </a>
                <form id="delete-form-{{ $event->id }}" action="{{ route('admin.event.destroy', $event->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
        ...
        <div class="col-span-full p-12 bg-white dark:bg-gray-800 rounded-xl shadow text-center">
            <div class="flex flex-col items-center">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-lg">Belum ada data berita yang tersedia.</p>
                <a href="{{ route('admin.event.create') }}"
