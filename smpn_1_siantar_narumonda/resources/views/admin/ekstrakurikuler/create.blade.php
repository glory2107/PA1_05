...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 my-8 animate-fade-in">
        <div>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">Isi informasi lengkap untuk ekstrakurikuler baru</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-md dark:bg-gray-800 overflow-hidden">
        ...
        <!-- Form Content -->
        <form action="{{ route('admin.ekstrakurikuler.store') }}" method="POST" enctype="multipart/form-data" class="p-6" novalidate>
    @csrf
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}"
                       ...
                       placeholder="Contoh: Basket, Futsal, dll" required>
            </div>

            <!-- Deskripsi Ekstrakurikuler dengan CKEditor -->
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="8"
                          class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                          placeholder="Tuliskan deskripsi lengkap mengenai ekstrakurikuler..." required>{{ old('description') }}</textarea>
            </div>
...
<!-- CKEditor CDN -->
<script src="https://cdn.ckeditor.com/ckeditor5/40.2.0/standard/ckeditor.js"></script>
<script>
    ClassicEditor
