...
<div class="container px-6 mx-auto grid"> 
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 my-8 animate-fade-in"> 
        <div> 
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">Isi informasi lengkap untuk galeri baru</p> 
        </div> 
        ...
        <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data" class="p-6"> 
            ...
            <div class="mb-6"> 
                ...
                <textarea id="description" name="description" rows="8" 
                          class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" 
                          placeholder="Tuliskan deskripsi lengkap mengenai galeri...">{{ old('description') }}</textarea> 
            </div> 
...
<script> 
    ...
    document.querySelector('form').addEventListener('submit', function(e) { 
        ...
        // Sinkronkan data CKEditor kembali ke textarea 
