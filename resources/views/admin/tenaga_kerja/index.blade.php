    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="overflow-hidden bg-white rounded-xl shadow-md dark:bg-gray-800 hover:shadow-xl transition-all duration-300 flex flex-col">
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-100 dark:border-gray-600">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300">{{ $kerja->jabatan }}</p>
            </div>
            ...
            <div class="relative overflow-hidden" style="height: 200px;">
                ...
                @else
                <div class="flex items-center justify-center w-full h-full text-gray-400 dark:text-gray-500 text-sm bg-gray-100 dark:bg-gray-700">
                    Tidak Ada Gambar
                </div>
                @endif
            </div>
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-100 dark:border-gray-600 flex justify-end gap-4">
                ...
                <form action="{{ route('admin.tenaga-kerja.destroy', $kerja->id) }}" method="POST"
                      onsubmit="return confirm('Yakin ingin menghapus tenaga kerja ini?')">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
